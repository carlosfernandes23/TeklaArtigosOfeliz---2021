...
{
    public partial class Frm_Corpo_de_Texto_Email_Enviar_Aprovisionamentos : Form
    {
        ...
        private string textbox1Import;
        private string textbox2Import;
        private string caminho;


        public Frm_Corpo_de_Texto_Email_Enviar_Aprovisionamentos(string titulo, string corpoEmail, string Subject, string textbox1, string textbox2 , string caminho)
        {
            InitializeComponent();
            this.Text = titulo;
            this.corpoEmail = corpoEmail;
            this.SubjectEnviarAprovisionamentos = Subject;
            this.textbox1Import = textbox1;
            this.textbox2Import = textbox2;
            this.caminho = caminho;
        }
          
        private void Corpo_de_Texto_Email_Enviar_Aprovisionamentos_Load(object sender, EventArgs e)
        {
        ...
        {
            string caminho = @"\\marconi\COMPANY SHARED FOLDER\OFELIZ\OFM\2.AN\2.CM\DP\4 Produção\Desenvolvimentos\Ficheiros Temp tekla artigos (Nao Apagar)\Diretor de Obra Base de dados\EmailAprovisionamentosCC.json";
        ...
        public async System.Threading.Tasks.Task SendEmailAsync(TextBox textBoxAsu)
        {
            ...
            string nomeUsuario2 = Environment.UserName;
            var emailAddress = GetEmailDiretorObra();
            ...
            string corpoEmail = @"
                                    <html>
                                    <body contenteditable='false' style='font-family: Calibri; font-size: 12pt;'>
                                        <p> " + saudacao + @"</p>
                                        <p>
                                            Venho por este meio informar que já solicitei o aprovisionamento 
                                            <span style='color:red;'>" + textbox1Import + @"</span> 
                                            da obra em assunto.
                                        </p>
                                        <p>
                                            <b>FASE " + textbox2Import + @":</b> 
                                            <span style='color:#5B9BD5;'>
                                                <u><a href='file:///" + caminho + @"' style='color:#5B9BD5;'>" + caminho + @"</a></u>
                                            </span>
                                        </p>
                                        ...
                                        <p>
                                            <i style='color: LightGrey; font-size: 10pt;'>Alvará Nº 10553 – Pub. *Chamada para a rede fixa nacional.</i><br>
                                            <i style='color: green; font-size: 10pt;'>Antes de imprimir este e-mail, tenha em consideração o meio ambiente.</i>
                                        </p>
                                    </body>
                                    </html>";
