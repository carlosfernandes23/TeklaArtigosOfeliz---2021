...
{
    public partial class Frm_Corpo_de_Texto_Email_Enviar_Para_Lotear : Form
    {
        private string corpoEmail;
        private string caminhoImagem;
        private string SubjectEnviarfabrico;
        private string tempImagePath;
        private string userDirectory;
        private string passwordFilePath;
        private string PastaModelo;
        private string textbox1;
        private string textbox2;

        public Frm_Corpo_de_Texto_Email_Enviar_Para_Lotear(string titulo, string corpoEmail, string Subject, string tempImagePath, string PastaModelo, string textbox1, string textbox2)
        {
            InitializeComponent();
            this.Text = titulo;
            this.corpoEmail = corpoEmail;
            this.SubjectEnviarfabrico = Subject;
            this.tempImagePath = tempImagePath;
            this.PastaModelo = PastaModelo;
            this.textbox1 = textbox1;
            this.textbox2 = textbox2;

        }

       private void Corpo_de_Texto_Email_Enviar_Para_Fabrico_Load(object sender, EventArgs e)
       {
            textBoxAsu.Text = SubjectEnviarfabrico;
        ...
        {
            string caminho = @"\\marconi\COMPANY SHARED FOLDER\OFELIZ\OFM\2.AN\2.CM\DP\4 Produção\Desenvolvimentos\Ficheiros Temp tekla artigos (Nao Apagar)\Diretor de Obra Base de dados\EmailLotearCC.json";
        ...
        public async System.Threading.Tasks.Task SendEmailAsync()
        {
            ...
            string corpoEmail = @"
                                    ...
                                    <body contenteditable='false'>
                                        ...
                                        <font face='Calibri' size='3'>
                                            <p>
                                                Venho por este meio informar que a modelação&nbsp;
                                                <span style='color:red;'>" + textbox1 + @",&nbsp;</span>
                                                está terminada, agradeço que analise e proceda com envio para fabrico da obra em assunto.
                                            </p>
                                        </font>
                                        <font face='Calibri' size='3'>
                                        ...
                                        <br>
                                        <font face='Calibri' size='3'>
                                            - O material a fabricar encontra-se modelado como&nbsp;
                                            <span style='color:red;'><u>Fase " + textbox2 + @"</u></span>
                                            do gestor de fases.
                                        </font>
                                        <br>
                                        <font face='Calibri' size='3'>
                                            <p>
                                                ...
                                                <font face='Calibri' size='3' style='color:#5B9BD5;'>
                                                    <u><a href='file:///" + PastaModelo + @"' style='color:#5B9BD5;'>" + PastaModelo + @"</a></u>
                                                </font>
                                            </p>
                                        </font>
                                        <font face='Calibri' size='3'>
                                            <p><b><u>PERSPETIVA DO MATERIAL A FABRICAR:</u></b></p>
                                        </font>
                                        <br>
